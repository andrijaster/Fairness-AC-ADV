...
Recently, Han et. al~\cite{han2021balancing} proposed a simple method for countering bias using instance reweighting, based on the frequency of both task labels and author\marginpar{Kakvi autori?} demographics. Similarly, Hayat~\cite{hayat2021towards} presented two distinct ways for bias mitagation based on reweighting procedure: cluster reweighting method and sample reweighting method.\marginpar{Ovo ne govori nista.} The idea of incorporating an outer optimizer for adaptively selecting mini batch sizes for the purpose of improving model fairness is presented in~\cite{roh2020fairbatch}.
