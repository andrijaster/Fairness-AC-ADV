...
\begin{itemize}
\item The overall Pareto front which is a Pareto front of all trained models (union of all model familites). Models which yield more points in such Pareto front are better.
\item Per family Pareto fronts, which are Pareto fronts obtained separately for different model families. They provide a more detailed view of models.
\end{itemize}
