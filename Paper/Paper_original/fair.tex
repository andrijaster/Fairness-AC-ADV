...
Since FAIR and baseline models do not directly optimize any of the commonly used fairness metrics, we evaluate them using several different fairness metrics. Hence, we present the overall Pareto front of all trained models with respect to AOD, ASD, and AEOD as fairness metrics and AUC as the performance metric.
