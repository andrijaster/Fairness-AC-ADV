...
class FAIR_betaSF_class():
    ...
    def __init__(self, input_size, num_layers_w,
        ...
        self.model = FAIR_betaSF_class.Fair_classifier(input_size, num_layers_w,
                     step_w, num_layers_A, step_A,
                      num_layers_y, step_y)
    ...
    def fit(self, dataloader, dataloader_val, early_stopping_no = 3, max_epoch = 300, mini_batch_size = 50, 
            alpha = 1, beta = 0, log_epoch = 10, log = 0):
