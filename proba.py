...
if __name__ == "__main__":
    ...
    saver_dir_models = r'Trained_models/Adult'    
    saver_dir_results= r'Results/Adult.xls' 
    ...
    for a in alpha:
        ...
        if np.isin(k ,model_AIF):
            ...
            lst[6].fit(dataloader_train, dataloader_val, max_epoch= epochs, log = 1, alpha = a, log_epoch=1)

        metric_val, metric_test = test(data_val, data_test, lst[6], output_val, output_test, 
