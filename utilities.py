...
def plot_AUC_Y_AUC_A(name):
    ...
    ax1 = plt.subplot(211)
    ax1.plot(points[points.index == 'FAIR-scalar']["alpha"], points[points.index == 'FAIR-scalar'].iloc[:,1], label = "ACC$_y$")
    ax1.plot(points[points.index == 'FAIR-scalar']["alpha"], points[points.index == 'FAIR-scalar'].iloc[:,2], label = "ACC$_s$")
    plt.xscale("log")
    ...
    ax2 = plt.subplot(212)
    ax2.plot(points[points.index == 'FAIR-scalar']["alpha"], points[points.index == 'FAIR-scalar'].iloc[:,1], label = "ACC$_y$")
    ax2.plot(points[points.index == 'FAIR-scalar']["alpha"], points[points.index == 'FAIR-scalar'].iloc[:,2], label = "ACC$_s$")
    plt.xscale("log")
    ax2.set_ylabel('ACC', fontweight="bold")
