...
file_name = os.path.join(saver_dir_res, 'Results_readmission_H_epoch_{}_model_no_{}.xls'.format(epochs, model_no))


if not os.path.exists(saver_dir_res):
    os.mkdir(saver_dir_res)
    
saver_dir_models = 'Trained_models/Readmission_H'    
...
for a in alpha:
    ...
    lst = [
        ...
        models_H.FAD_H_class(input_size = inp, num_layers_z = 3, num_layers_y = 2, 
                                  step_z = 2, step_y = 2),
        models_H.FAIR_scalar_H_class(input_size = inp, num_layers_w = 2, step_w = 2, 
                 num_layers_A = 2, step_A = 2, num_layers_y = 3, step_y = 2),
        models_H.FAIR_betaSF_H_class(input_size = inp, num_layers_w = 2, step_w = 2, 
                 num_layers_A = 2, step_A = 2, num_layers_y = 3, step_y = 2),
        models_H.FAIR_Bernoulli_H_class(input_size = inp, num_layers_w = 2, step_w = 2, 
                 num_layers_A = 2, step_A = 2, num_layers_y = 3, step_y = 2),
        models_H.FAIR_betaREP_H_class(input_size = inp, num_layers_w = 2, step_w = 2, 
                 num_layers_A = 2, step_A = 2, num_layers_y = 3, step_y = 2),
