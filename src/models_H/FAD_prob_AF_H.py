...
class FAD_prob_AF_H_class():
    ...
    def __init__(self, input_size, num_layers_z, num_layers_y, step_z, step_y):
        self.model = FAD_prob_AF_H_class.FairClass(input_size, num_layers_z, num_layers_y, step_z, step_y)
