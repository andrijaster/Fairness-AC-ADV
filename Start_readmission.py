...
if __name__ == "__main__":
    ...
    saver_dir_models = r'Trained_models/Readmission'    
    saver_dir_results= r'Results/readmission.xls' 


    data, atribute, sensitive, output, pr_gr, un_gr = Readmission_dataset()
